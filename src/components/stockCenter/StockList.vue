<template>
    <div class="stock_list">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="品牌:"  size="small">
                            <el-select placeholder="请选择品牌" style="width:194px;" v-model="value">
        ...
        <div class="pop1" v-show="pop1Flag" style="width:805px;height:510px;">
            <div class="pop1_head">
        ...
        <div class="pop1" v-show="pop2Flag" style="width:472px;height:288px;">
            <div class="pop1_head">
                <span class="pop1_txt">商品补货</span>
