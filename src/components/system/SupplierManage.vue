    ...
    <div class="sj_manage_table">
      ...
      <div class="table_block">
        <el-table border style="width: 100%" :data="initTable" height="563px">
          <el-table-column align="center" prop="companyCode" label="供应商编码"></el-table-column>
          <el-table-column align="center" prop="companyName" label="供应商名称"></el-table-column>
          <el-table-column align="center" prop="companyTypeStr" label="公司类型"></el-table-column>
          <el-table-column align="center" prop="statusStr" label="联系人"></el-table-column>
          <el-table-column align="center" prop="saleChannelStr" label="联系电话"></el-table-column>
          <el-table-column align="center" prop="mallDisplayStyleStr" label="启用状态"></el-table-column>
      ...
      <div class="pop1 content">
        ...
        <div class="pop1_main" style="padding: 20px 20px;height:700px;" ref="scroll">
          <el-form label-width="120px" :rules="rule" ref="editParam" :model="editParam">
            ...
            <div
              style="border-top: #c6c9d3 1px dashed; overflow: hidden; height: 1px; margin: 10px 10px;"
            ></div>
            ...
            <el-form-item label="联系电话:" size="small" prop="contactMobileNo">
              <el-input
                placeholder="请输入联系电话"
                v-model="editParam.contactMobileNo"
                style="width:320px;"
              ></el-input>
            </el-form-item>
            <el-form-item label="联系地址:" size="small" prop="contactDetailAddress">
              ...
              <el-col :span="23">
                <el-input
                  ...
                  v-model="editParam.contactDetailAddress"
                ></el-input>
              </el-col>
            </el-form-item>
            ...
            <el-form-item label="帐期:" size="small" prop="legalRepresentativeName">
              <el-input
                placeholder="请输入帐期"
                v-model="editParam.legalRepresentativeName"
                style="width:320px;"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="付款方式:" size="small" prop="legalRepresentativeCertNo">
              <el-select
                placeholder="街道"
                v-model="editParam.contactDistrictCode"
                style="width:320px;"
              >
                <el-option label="全部" :value="1"></el-option>
                <el-option label="商家" :value="2"></el-option>
            ...
            <el-form-item label="账户名称:" size="small" prop="legalRepresentativeMobileNo">
              <el-input
                placeholder="请输入账户名称"
                v-model="editParam.legalRepresentativeMobileNo"
                style="width:320px;"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="支行名称:" size="small" prop="legalRepresentativeCertNo">
              <el-input
                ...
                v-model="editParam.legalRepresentativeCertNo"
                style="width:320px;"
              ></el-input>
            </el-form-item>
            <el-form-item label="企业名称:" size="small" prop="corporationName">
              <el-input
                placeholder="请输入企业名称"
                v-model="editParam.corporationName"
                style="width:320px;"
              ></el-input>
            </el-form-item>
            <el-form-item label="公司税号:" size="small" prop="businessLicenceNo">
              <el-input
                placeholder="请输入公司税号"
                v-model="editParam.businessLicenceNo"
                style="width:320px;"
              ></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      this.$axios.post("/member/supplierInfo/queryList", this.searchParam).then(res => {
          if (res.data.code == "0") {
