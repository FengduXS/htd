    ...
    <div class="deliver_manage_table">
      <div class="table_block">
        <el-table border style="width: 100%" :data="initTable" height="668px">
          <el-table-column align="center" prop="packageId" label="售后服务名称"></el-table-column>
          <el-table-column align="center" prop="packageState" label="是否启用"></el-table-column>
          <el-table-column align="center" prop="kdName" label="创建时间"></el-table-column>
...
export default {
  ...
  methods: {
    search() {
      ...
      this.$axios.post("/member/serviceInfo/queryServiceList", this.searchParam).then(res => {
          if (res.data.code == "0") {
    ...
    //   debugger;
      ...
      this.$cusMessageBox({
        ...
        confirmFn() {
            ...
            _this.$axios.post(`/member/serviceInfo/deleteById`,params).then((res)=>{
                if(res.code== 200){
