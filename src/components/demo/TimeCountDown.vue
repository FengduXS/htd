<template>
    ...
    <div class="downTime-wrapper">
        <div class="time" v-show="!isShow">
            ...
            <span class="hour" v-show="isShowDay">{{myDay}}</span>
            <span v-show="isShowDay">天</span>
    ...
    export default {
        ...
        mounted () {
            ...
            let timeFunction = () => {
                ...
                this.isShowDay = this.myDay > 0 ? true : false; //是否显示天数
